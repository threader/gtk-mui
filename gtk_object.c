 ...
 *
 * $Id: gtk_object.c,v 1.6 2007/06/19 13:33:17 o1i Exp $
 */
...
GType gtk_object_get_type (void) {
  ...
  if (!object_type) {
    ...
    object_type = g_type_register_static (GTK_TYPE_MUI, "GtkObject", 
		 ...
		 GtkObjectClass *klass)
{
  ...
  GTK_MUI(object)->mainclass=CL_OTHER;
}
