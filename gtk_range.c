 ...
 *
 * $Id: gtk_range.c,v 1.4 2008/08/07 09:17:45 o1i Exp $
 */
...
static void gtk_range_class_init (GtkRangeClass *class) {

  GObjectClass   *gobject_class;
  GtkObjectClass *object_class;
  GtkWidgetClass *widget_class;

  DebOut("gtk_range_class_init(%lx)\n",class);
...
/* enable property update_policy was disabled .. for a good? */
...
static void gtk_range_set_property (GObject      *object,
  ...
  DebOut("gtk_range_set_property(%lx,%d,..)\n",object,prop_id);
...
static void gtk_range_get_property (GObject      *object,
  ...
  DebOut("gtk_range_get_property(%lx,%d,..)\n",object,prop_id);
...
static void gtk_range_init (GtkRange *range) {
  ...
  GTK_MUI(range)->mainclass=CL_OTHER;
}
