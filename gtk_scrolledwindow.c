 ...
 *
 * $Id: gtk_scrolledwindow.c,v 1.3 2009/05/17 18:37:48 stefankl Exp $
 */
...
{
  DebOut("gtk_scrolled_window_init(%lx)\n");
  ...
  GtkSetObj(GTK_WIDGET(scrolled_window), NewObject(CL_Scrolledwindow->mcc_Class, NULL,
                                                        MA_Widget, (ULONG) scrolled_window,
                                                        TAG_DONE));

  if(!GtkObj(scrolled_window)) {
    ErrOut("gtk_scrolled_window_init: Could not create object of Scrollgroup.mui\n");
  }
			 ...
			 GtkAdjustment *vadjustment)
{
  ...
  DebOut("gtk_scrolled_window_new(%lx)\n");
...
{
#warning gtk_scrolled_window_set_hadjustment is TODO
#if 0
  GtkBin *bin;
...
gtk_scrolled_window_set_vadjustment (GtkScrolledWindow *scrolled_window,
				     GtkAdjustment     *vadjustment)
{
#warning warning gtk_scrolled_window_set_vadjustment is TODO
#if 0
  GtkBin *bin;
...
gtk_scrolled_window_scroll_event (GtkWidget *widget,
				  GdkEventScroll *event)
{
  WarnOut("gtk_scrolled_window_scroll_event is TODO!\n");
#warning gtk_scrolled_window_scroll_event is TODO!
#if 0
  GtkWidget *range;
...
#endif
  mgtk_add(GTK_WIDGET(container),child);
}
...
gtk_scrolled_window_add_with_viewport (GtkScrolledWindow *scrolled_window,
				       GtkWidget         *child)
{
  ErrOut("gtk_scrolled_window_add_with_viewport is not done yet!\n");
#if 0
  GtkBin *bin;
  GtkWidget *viewport;
