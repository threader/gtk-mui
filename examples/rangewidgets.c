 ...
 *
 * $Id: rangewidgets.c,v 1.3 2012/05/10 08:48:00 o1i Exp $
 */
...
void create_range_controls( void )
{
    ...
    /* test gtk_adjustment_set_value */
    box4 = gtk_hbox_new (FALSE, 10);
    adj3=gtk_adjustment_new (2048, 1, 5121, 1, 512, 1);

    slider=gtk_hscale_new (GTK_ADJUSTMENT(adj3));
    gtk_scale_set_digits (GTK_SCALE (slider), 0);
    gtk_widget_show (slider);
    gtk_box_pack_start (GTK_BOX (box4), slider, TRUE, TRUE, 0);
    ...
    gtk_adjustment_set_value(GTK_ADJUSTMENT(adj3), 666);
}
