 ...
 *
 * $Id: gtk_typeutils.c,v 1.3 2007/06/19 13:33:18 o1i Exp $
 */
		 ...
		 const GtkTypeInfo *gtkinfo)
{
  ...
  DebOut("  parent_type: %lx (%s)\n",parent_type,g_type_name(parent_type));
  DebOut("  tinfo.class_size: %lx\n",tinfo.class_size);
  DebOut("  tinfo.instance_size: %lx\n",gtkinfo->object_size);
