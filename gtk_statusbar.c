...
static void gtk_statusbar_class_init               (GtkStatusbarClass *klass);
static void gtk_statusbar_init                     (GtkStatusbar      *statusbar);
static void gtk_statusbar_destroy                  (GtkObject         *object);
static void gtk_statusbar_finalize                 (GObject           *object);
  ...
  if (!statusbar_type)
    {
      ...
      //statusbar_type = g_type_register_static (gtk_hbox_get_type (), "GtkStatusbar", &statusbar_info, 0);
      statusbar_type = g_type_register_static (GTK_TYPE_HBOX, "GtkStatusbar", &statusbar_info, 0);
    }
...
gtk_statusbar_class_init (GtkStatusbarClass *class)
{
  ...
  statusbar_signals[SIGNAL_TEXT_PUSHED] =
    gtk_signal_new ("text_pushed",
        ...
        // _gtk_marshal_NONE__UINT_STRING, // original
        G_TYPE_NONE, 2,
        G_TYPE_UINT,
        G_TYPE_STRING);
  statusbar_signals[SIGNAL_TEXT_POPPED] =
    gtk_signal_new ("text_popped",
        ...
        G_TYPE_UINT,
        G_TYPE_STRING);
  //gtk_object_class_add_signals (object_class, statusbar_signals, SIGNAL_LAST); // original

  object_class->destroy = gtk_statusbar_destroy;
  gobject_class->finalize = gtk_statusbar_finalize;
...
gtk_statusbar_init (GtkStatusbar *statusbar)
{
  ...
  GtkSetObj(GTK_WIDGET(statusbar), NewObject(CL_StatusBar->mcc_Class, NULL,MA_Widget,(ULONG) statusbar,TAG_DONE));
  */
}
...
//        class = GTK_STATUSBAR_CLASS (G_OBJECT (statusbar)->klass); // original
    class = GTK_STATUSBAR_CLASS (GTK_OBJECT (statusbar));
...
static void
gtk_statusbar_finalize (GObject *object)
{
  GtkStatusbar *statusbar;
