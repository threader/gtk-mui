 ...
 *
 * $Id: gtk_spinbutton.c,v 1.14 2009/05/17 18:37:48 stefankl Exp $
 */
...
GType gtk_spin_button_get_type (void) {
  ...
  if (!spin_button_type) {
    ...
    spin_button_type = g_type_register_static (GTK_TYPE_ENTRY, "GtkSpinButton", &spin_button_info, 0);
...
static void gtk_spin_button_class_init (GtkSpinButtonClass *class) {
  ...
  DebOut("gtk_spin_button_class_init(%lx)\n",class);
...
#endif
  widget_class->size_request = NULL;
  widget_class->size_allocate = NULL;
  widget_class->expose_event = NULL;
...
static void gtk_spin_button_editable_init (GtkEditableClass *iface) {
  ...
  DebOut("gtk_spin_button_editable_init(%lx)\n",iface);

  /* this will *NOT* work!! (TODO) */
...
static void gtk_spin_button_init (GtkSpinButton *spin_button) {
  ...
  DebOut("gtk_spin_button_init(%lx)\n",spin_button);
  ...
  GtkSetObj(GTK_WIDGET(spin_button), NewObject(CL_SpinButton->mcc_Class, NULL,MA_Widget,(ULONG) spin_button,TAG_DONE));

  value=g_strdup_printf("%f",GTK_SPIN_BUTTON(spin_button)->adjustment->value);
  set(GtkObj(spin_button),MA_Spin_Value,(ULONG) value);
  g_free(value);

  /* add this Widget to the adjustment */
  GTK_MUI(spin_button->adjustment)->remember=g_slist_append(GTK_MUI(spin_button->adjustment)->remember,spin_button);
			       ...
			       GtkSpinButton *spin_button)
{
  ...
  DebOut("gtk_spin_button_value_changed(%lx,%lx)\n");

  value=g_strdup_printf("%f",spin_button->adjustment->value);
  set(GtkObj(spin_button),MA_Spin_Value,(ULONG) value);
  g_free(value);
...
gtk_spin_button_activate (GtkEntry *entry)
{
  ...
  DebOut("gtk_spin_button_activate(%lx)\n",entry);
			     ...
			     gint        *position)
{
  ...
  WarnOut("gtk_spin_button_insert_text has never been tested!!\n");
			   ...
			   guint           digits)
{
  ...
  DebOut("gtk_spin_button_configure(%lx,%lx,..,%d)\n",spin_button,adjustment,digits);
...
GtkWidget * gtk_spin_button_new (GtkAdjustment *adjustment, gdouble climb_rate, guint digits) {
  ...
  DebOut("gtk_spin_button_new(%lx,..,%d)\n",adjustment,digits);
				...
				gdouble step)
{
  ...
  DebOut("gtk_spin_button_new_with_range(..)\n");
				...
				GtkAdjustment *adjustment)
{
  ...
  DebOut("gtk_spin_button_set_adjustment(%lx,%lx)\n",spin_button,adjustment);
...
GtkAdjustment * gtk_spin_button_get_adjustment (GtkSpinButton *spin_button) {
  ...
  DebOut("gtk_spin_button_get_adjustment(%lx)\n",spin_button);
			    ...
			    guint          digits)
{
  ...
  DebOut("gtk_spin_button_set_digits(%lx,%d)\n",spin_button,digits);
...
gtk_spin_button_set_increments (GtkSpinButton *spin_button,
  ...
  DebOut("gtk_spin_button_set_increments(%lx,..,..)\n",spin_button);
			   ...
			   gdouble        max)
{
  ...
  DebOut("gtk_spin_button_set_range(%lx,..,..)\n",spin_button);
			   ...
			   gdouble        value)
{
  ...
  WarnOut("gtk_spin_button_set_value never tested\n");
...
{
#warning spin_button_get_arrow_size disabled
#if 0
...
gtk_spin_button_update (GtkSpinButton *spin_button)
{
  ...
  DebOut("gtk_spin_button_update(%lx)\n",spin_button);
