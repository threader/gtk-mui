 ...
 *
 * $Id: gtk_menu.c,v 1.19 2009/05/17 18:37:48 stefankl Exp $
 */
...
static void gtk_menu_class_init (GtkMenuClass *class) {
...
static void gtk_menu_set_property (GObject      *object,
  ...
  DebOut("gtk_menu_set_property(%lx,%d,..)\n",object,prop_id);
...
gtk_menu_window_size_request (GtkWidget      *window,
			      ...
			      GtkMenu        *menu)
{
  WarnOut("gtk_menu_window_size_request: TODO ?\n");
...
{
  WarnOut("menu_change_screen missing\n");
#if 0
  GtkMenuPrivate *private = gtk_menu_get_private (menu);
			   ...
			   GtkMenuDetachFunc	detacher)
{
  ...
  DebOut("gtk_menu_attach_to_widget(%lx,%lx,..)\n",menu,attach_widget);
...
gtk_menu_popup (GtkMenu		    *menu,
		...
		guint32		     activate_time)
{
  WarnOut("gtk_menu_popup: we might need this (missing!)\n");
#if 0
  GtkWidget *widget;
  ...
  if (xgrab_shell && xgrab_shell != widget)
    {
      WarnOut("deactivated popup_grab_on_window..\n");
#if 0
  ...
  else
    {
      ...
      WarnOut("deactivated popup_grab_on_window (2)..\n");
#if 0
                                  ...
                                  guint      signal_id)
{
   ...
   */
   WarnOut("gtk_menu_real_can_activate_accel not fully implemented\n");
#if 0
			       ...
			       gboolean group_changed)
{
  ...
  WarnOut("_gtk_menu_refresh_accel_paths not implemented yet\n");
#if 0
			    ...
			    gboolean  torn_off)
{
  ...
  WarnOut("gtk_menu_set_tearoff_state(%lx,%d) not implemented!\n",(LONG) menu,torn_off);
  return;
#if 0
  gint width, height;
...
menu_grab_transfer_window_get (GtkMenu *menu)
{
  ...
  WarnOut("menu_grab_transfer_window_get disabled\n");
#if 0
  if (!window)
    {
      GdkWindowAttr attributes;
...
menu_grab_transfer_window_destroy (GtkMenu *menu)
{
  ...
  if (window)
    {
      WarnOut("menu_grab_transfer_window_destroy: gdk_window_destroy missing\n");
...
gtk_menu_size_allocate (GtkWidget     *widget,
			GtkAllocation *allocation)
{
  WarnOut("gtk_menu_size_allocate.. we should not need this\n");
#if 0
  GtkMenu *menu;
  GtkMenuShell *menu_shell;
  GtkWidget *child;
...
gtk_menu_paint (GtkWidget      *widget,
		GdkEventExpose *event)
{
  WarnOut("gtk_menu_paint should do someone other..missing\n");
...
gtk_menu_key_press (GtkWidget	*widget,
		    GdkEventKey *event)
{
  WarnOut("gtk_menu_key_press(%lx,%lx) not impemented yet\n",(LONG) widget,(LONG) event);
			 ...
			 GdkEventMotion    *event)
{
  ...
  WarnOut("gtk_menu_motion_notify missing\n");
  return FALSE;
#if 0
  GtkWidget *menu_item;
  GtkMenu *menu;
...
gtk_menu_scroll_by (GtkMenu *menu, 
		    gint     step)
{
  WarnOut("gtk_menu_scroll_by missing..\n");
#if 0
  GtkWidget *widget;
  gint offset;
...
gtk_menu_enter_notify (GtkWidget        *widget,
		       GdkEventCrossing *event)
{
  WarnOut("gtk_menu_enter_notify missing\n");
  return TRUE;
#if 0
  GtkWidget *menu_item;
...
gtk_menu_leave_notify (GtkWidget        *widget,
		       GdkEventCrossing *event)
{
  WarnOut("gtk_menu_leave_notify missing\n");
  return TRUE;
...
gtk_menu_set_submenu_navigation_region (GtkMenu          *menu,
					...
					GdkEventCrossing *event)
{
  WarnOut("gtk_menu_set_submenu_navigation_region.. missing\n");
#if 0
  gint submenu_left = 0;
...
{
  WarnOut("gtk_menu_position(%lx) missing\n",(LONG) menu);
#if 0
  GtkWidget *widget;
  GtkRequisition requisition;
  GtkMenuPrivate *private;
...
gtk_menu_scroll_to (GtkMenu *menu,
		    gint    offset)
{
  WarnOut("gtk_menu_scroll_to should not be needed (missing)\n");
#if 0
  GtkWidget *widget;
  gint x, y;
  gint view_width, view_height;
...
gtk_menu_scroll_item_visible (GtkMenuShell    *menu_shell,
			      GtkWidget       *menu_item)
{
  WarnOut("gtk_menu_scroll_item_visible missing\n");
#if 0
  GtkMenu *menu;
...
gtk_menu_show_all (GtkWidget *widget)
{
  ...
  WarnOut("gtk_menu_show_all not implemented\n");
#if 0
...
{
  WarnOut("gtk_menu_hide_all not implemented\n");
#if 0
